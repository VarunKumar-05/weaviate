...
func TestSegmentGroup_CompactionPairToFixLevelsOrder(t *testing.T) {
	...
	*/
	...
	testCases := []struct {
		...
		// 	name: "3.1",
		// 	segments: []Segment{
		// 		&segment{size: 1000, path: "seg_09", level: 7},
		// 		&segment{size: 1000, path: "seg_08", level: 5},
		// 		&segment{size: 1000, path: "seg_07", level: 3},
		// 		&segment{size: 1000, path: "seg_06", level: 9},
		// 		&segment{size: 1000, path: "seg_05", level: 7},
		// 		&segment{size: 1000, path: "seg_04", level: 5},
		// 		&segment{size: 1000, path: "seg_03", level: 8},
		// 		&segment{size: 1000, path: "seg_02", level: 6},
		...
		// 		&segment{size: 1000, path: "seg_07", level: 3},
		// 		&segment{size: 1000, path: "seg_06", level: 9},
		// 		&segment{size: 1000, path: "seg_0504", level: 7},
		// 		&segment{size: 1000, path: "seg_03", level: 8},
		// 		&segment{size: 1000, path: "seg_02", level: 6},
		// 		&segment{size: 1000, path: "seg_01", level: 4},
		// 	},
		...
		// 		&segment{size: 1000, path: "seg_08", level: 5},
		// 		&segment{size: 1000, path: "seg_07", level: 3},
		// 		&segment{size: 1000, path: "seg_060504", level: 9},
		// 		&segment{size: 1000, path: "seg_03", level: 8},
		// 		&segment{size: 1000, path: "seg_02", level: 6},
		// 		&segment{size: 1000, path: "seg_01", level: 4},
		// 	},
		...
		// 	segments: []Segment{
		// 		&segment{size: 1000, path: "seg_09", level: 7},
		// 		&segment{size: 1000, path: "seg_0807", level: 5},
		// 		&segment{size: 1000, path: "seg_060504", level: 9},
		// 		&segment{size: 1000, path: "seg_03", level: 8},
		// 		&segment{size: 1000, path: "seg_02", level: 6},
		// 		&segment{size: 1000, path: "seg_01", level: 4},
		...
		// 	name: "3.6",
		// 	segments: []Segment{
		// 		&segment{size: 1000, path: "seg_090807060504", level: 10},
		// 		&segment{size: 1000, path: "seg_03", level: 8},
		// 		&segment{size: 1000, path: "seg_02", level: 6},
		// 		&segment{size: 1000, path: "seg_01", level: 4},
		// 	},
		...
		// 		&segment{size: 1000, path: "seg_05", level: 5},
		// 		&segment{size: 1000, path: "seg_04", level: 3},
		// 		&segment{size: 1000, path: "seg_03", level: 8},
		// 		&segment{size: 1000, path: "seg_02", level: 6},
		// 		&segment{size: 1000, path: "seg_01", level: 4},
		// 	},
		...
		// 		&segment{size: 1000, path: "seg_07", level: 5},
		// 		&segment{size: 1000, path: "seg_06", level: 7},
		// 		&segment{size: 1000, path: "seg_0504", level: 5},
		// 		&segment{size: 1000, path: "seg_03", level: 8},
		// 		&segment{size: 1000, path: "seg_02", level: 6},
		// 		&segment{size: 1000, path: "seg_01", level: 4},
		// 	},
		...
		// 		&segment{size: 1000, path: "seg_08", level: 7},
		// 		&segment{size: 1000, path: "seg_07", level: 5},
		// 		&segment{size: 1000, path: "seg_060504", level: 7},
		// 		&segment{size: 1000, path: "seg_03", level: 8},
		// 		&segment{size: 1000, path: "seg_02", level: 6},
		// 		&segment{size: 1000, path: "seg_01", level: 4},
		// 	},
		...
		// 	segments: []Segment{
		// 		&segment{size: 1000, path: "seg_09", level: 9},
		// 		&segment{size: 1000, path: "seg_0807060504", level: 8},
		// 		&segment{size: 1000, path: "seg_03", level: 8},
		// 		&segment{size: 1000, path: "seg_02", level: 6},
		// 		&segment{size: 1000, path: "seg_01", level: 4},
		// 	},
		...
		// 	name: "4.7",
		// 	segments: []Segment{
		// 		&segment{size: 1000, path: "seg_09080706050403", level: 10},
		// 		&segment{size: 1000, path: "seg_02", level: 6},
		// 		&segment{size: 1000, path: "seg_01", level: 4},
		// 	},
		// 	expPair: nil,
		...
		// 	name: "6.1",
		// 	segments: []Segment{
		// 		&segment{size: 1000, path: "seg_10", level: 4},
		// 		&segment{size: 1000, path: "seg_09", level: 3},
		// 		&segment{size: 1000, path: "seg_08", level: 2},
		// 		&segment{size: 1000, path: "seg_07", level: 1},
		// 		&segment{size: 1000, path: "seg_06", level: 1},
		// 		&segment{size: 1000, path: "seg_05", level: 1},
		// 		&segment{size: 1000, path: "seg_04", level: 2},
		// 		&segment{size: 1000, path: "seg_03", level: 3},
		// 		&segment{size: 1000, path: "seg_02", level: 4},
		// 		&segment{size: 1000, path: "seg_01", level: 3},
		// 	},
		...
		// 		&segment{size: 1000, path: "seg_09", level: 3},
		// 		&segment{size: 1000, path: "seg_08", level: 2},
		// 		&segment{size: 1000, path: "seg_0706", level: 2},
		// 		&segment{size: 1000, path: "seg_05", level: 1},
		// 		&segment{size: 1000, path: "seg_04", level: 2},
		// 		&segment{size: 1000, path: "seg_03", level: 3},
		// 		&segment{size: 1000, path: "seg_02", level: 4},
		...
		// 		&segment{size: 1000, path: "seg_09", level: 3},
		// 		&segment{size: 1000, path: "seg_08", level: 2},
		// 		&segment{size: 1000, path: "seg_070605", level: 2},
		// 		&segment{size: 1000, path: "seg_04", level: 2},
		// 		&segment{size: 1000, path: "seg_03", level: 3},
		// 		&segment{size: 1000, path: "seg_02", level: 4},
		// 		&segment{size: 1000, path: "seg_01", level: 3},
		...
		// 		&segment{size: 1000, path: "seg_10", level: 4},
		// 		&segment{size: 1000, path: "seg_09", level: 3},
		// 		&segment{size: 1000, path: "seg_08070605", level: 3},
		// 		&segment{size: 1000, path: "seg_04", level: 2},
		// 		&segment{size: 1000, path: "seg_03", level: 3},
		// 		&segment{size: 1000, path: "seg_02", level: 4},
		// 		&segment{size: 1000, path: "seg_01", level: 3},
		...
		// 		&segment{size: 1000, path: "seg_10", level: 4},
		// 		&segment{size: 1000, path: "seg_09", level: 3},
		// 		&segment{size: 1000, path: "seg_0807060504", level: 3},
		// 		&segment{size: 1000, path: "seg_03", level: 3},
		// 		&segment{size: 1000, path: "seg_02", level: 4},
		// 		&segment{size: 1000, path: "seg_01", level: 3},
		// 	},
		...
		// },
		{
			...
			segments: []Segment{
				&segment{size: 1000, path: "seg_10", level: 4},
				&segment{size: 1000, path: "seg_090807060504", level: 4},
				&segment{size: 1000, path: "seg_03", level: 3},
				&segment{size: 1000, path: "seg_02", level: 4},
				&segment{size: 1000, path: "seg_01", level: 3},
			},
		...
		// 	segments: []Segment{
		// 		&segment{size: 1000, path: "seg_10", level: 4},
		// 		&segment{size: 1000, path: "seg_09080706050403", level: 4},
		// 		&segment{size: 1000, path: "seg_02", level: 4},
		// 		&segment{size: 1000, path: "seg_01", level: 3},
		// 	},
		...
		// 	name: "6.8",
		// 	segments: []Segment{
		// 		&segment{size: 1000, path: "seg_1009080706050403", level: 5},
		// 		&segment{size: 1000, path: "seg_02", level: 4},
		// 		&segment{size: 1000, path: "seg_01", level: 3},
		// 	},
		// 	expPair: nil,
